...
public class HashCommand implements Command {
	...
	public void run() throws IOException {
		...
		for (File directory : directories) {
			System.out.println("Processing directory:" + directory.toPath());
			// Add new entries
	...
	private void removeStalledEntries(DB hashDb, PerimeterFilter pf, File dir) throws IOException {
		...
		System.out.println("Removing stalled entries from:" + dir);
	...
	private static class Hasher extends SimpleFileVisitor<Path> {
		...
		public FileVisitResult visitFile(Path path, BasicFileAttributes paramBasicFileAttributes) throws IOException {
	...
	/**
	 * This class implements the filter that keeps the files that we want to hash.
	 * <br/>
	 * We will remove:
	 * <ol>
	 * <li>not existing !</li>
